...
*This document can be used by any implementer to align code with the paper. Optionally, an addendum can map each requirement to the current status or suggested changes for a specific codebase.*
