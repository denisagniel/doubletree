...
The following theorem combines the oracle inequality framework from \citet{xuStatisticalOptimalityOptimal2026} with the loss-norm link (Lemma~\ref{lem:loss-norm}) and the DML rate condition to establish the convergence rate of tree-based nuisance estimators for causal inference.
