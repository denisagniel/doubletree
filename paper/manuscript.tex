...
\paragraph{Other causal parameters.}
...
\paragraph{Computational improvements.}
...
\paragraph{Robust loss functions.}
...
\paragraph{Sufficiency for valid inference (second part of theorem).}
...
\paragraph{Step 2: Strong convexity of negative entropy implies KL lower bound.}
...
\paragraph{Connection to EIF-based estimation.}
