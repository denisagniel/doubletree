% B7: DML Validity - Explicit Verification of Chernozhukov (2018) Conditions
...
\paragraph{Conclusion.}
By Chernozhukov et al.\ (2018, Theorem~3.1), the DML estimator with nuisances $\tilde{\eta}^{(-k)}$ satisfies:
\[
\sqrt{n}(\hat\theta - \theta_0) \leadsto N(0, \sigma^2),
\]
...
\subsection{Verification of DML Conditions for Tree Nuisances}
...
All four conditions (C1)-(C4) of Chernozhukov et al.\ (2018, Theorem~3.1) are verified for tree-based nuisances in the ATT setting. Thus the DML estimator with tree nuisances achieves:
\[
