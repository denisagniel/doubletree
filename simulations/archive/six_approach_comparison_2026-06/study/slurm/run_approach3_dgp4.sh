#!/bin/bash
#SBATCH --job-name=approach3_dgp4
#SBATCH --output=logs/approach3_dgp4_%a.out
#SBATCH --error=logs/approach3_dgp4_%a.err
#SBATCH --array=1-1000
...
# Approach 3: Doubletree -- DGP 4 (continuous features) ONLY
...
#
# Output files named approach3_dgp4_${JOB_ID}.rds to avoid collision with
# the DGPs-1-3 script which uses approach3_${JOB_ID}.rds.
#
