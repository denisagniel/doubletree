// ============================================================
// proc_footprint.cpp
// Study: threshold_superconsistency  (doubletree)  -- copied verbatim from
// single_tree_coverage/code/proc_footprint.cpp (2026-08-04), which is this
// repo's established macOS memory probe.
//
...
//
// Not run directly. Sourced by run_cell.R.
// ============================================================
