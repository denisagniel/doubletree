...
echo "  - Batches: 10 batches of 50 reps each"
echo ""
...
for N in 1000 2000; do
  echo "Submitting: n=${N} (10 batches)"

  sbatch --export=N=${N} --array=1-10 adaptive_cv_batch.slurm

  TOTAL_JOBS=$((TOTAL_JOBS + 10))
  sleep 0.2
done
...
echo "  # Should have 20 files when complete (2 configs × 10 batches)"
echo ""
