...
%
% SUPERSEDED 2026-07-01. This standalone draft is NOT \input into manuscript.tex.
% The authoritative loss-norm link is Lemma~\ref{lem:loss-norm} in the
% nuisance-rate appendix (_pshab_appendix_draft.tex), restated as
% lem:ce-loss-norm in the app:loss-norm section. That version corrects the
% constant to U_c = min{1/(2c^2), 1/(c(1-c))} (this draft's O(1/c^2) derivation
% below contains exploratory "Wait/No/Actually" text and is retained only for
% history). Do not cite this file.
