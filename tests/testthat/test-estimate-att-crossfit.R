# estimate_att_crossfit() / estimate_att_rashomon() and shared EIF-kernel
# tests (psi_att, create_folds, att_se, att_ci). For the flagship, no-sample-
# splitting estimator (Part II, sec:main), see test-estimate-att.R.
