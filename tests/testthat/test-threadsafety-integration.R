...
test_that("estimate_att_crossfit produces identical results with worker_limit=1 vs worker_limit=4", {
...
test_that("estimate_att_crossfit with continuous outcome and worker_limit=4 is stable", {
  skip_if_not_installed("optimaltrees")
...
test_that("estimate_att_rashomon with worker_limit=4 works correctly", {
  skip_if_not_installed("optimaltrees")
...
test_that("stress test: multiple estimate_att_crossfit runs with worker_limit=4 are stable", {
  skip_if_not_installed("optimaltrees")
